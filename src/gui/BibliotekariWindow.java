...
public class BibliotekariWindow extends JFrame {
	...
	public BibliotekariWindow() {
		...
		lblNewLabel.setBounds(625, 20, 46, 14);
		panel.add(lblNewLabel);
		
		id = new JTextField();
		id.setBounds(706, 11, 178, 20);
		panel.add(id);
		id.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Ime");
		lblNewLabel_1.setBounds(625, 51, 46, 14);
		panel.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Prezime");
		lblNewLabel_2.setBounds(625, 76, 46, 14);
		panel.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Adresa");
		lblNewLabel_3.setBounds(625, 234, 46, 14);
		panel.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("JMBG");
		lblNewLabel_4.setBounds(625, 107, 46, 14);
		panel.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Korisnicko ime");
		lblNewLabel_5.setBounds(625, 139, 71, 14);
		panel.add(lblNewLabel_5);
		
		JLabel lblNewLabel_5_1 = new JLabel("Sifra");
		lblNewLabel_5_1.setBounds(625, 167, 46, 14);
		panel.add(lblNewLabel_5_1);
		
		ime = new JTextField();
		ime.setBounds(706, 42, 178, 20);
		panel.add(ime);
		ime.setColumns(10);
		
		prezime = new JTextField();
		prezime.setColumns(10);
		prezime.setBounds(706, 73, 178, 20);
		panel.add(prezime);
		
		jmbg = new JTextField();
		jmbg.setColumns(10);
		jmbg.setBounds(706, 104, 178, 20);
		panel.add(jmbg);
		
		korisnickoIme = new JTextField();
		korisnickoIme.setColumns(10);
		korisnickoIme.setBounds(706, 136, 178, 20);
		panel.add(korisnickoIme);
		
		sifra = new JTextField();
		sifra.setColumns(10);
		sifra.setBounds(706, 164, 178, 20);
		panel.add(sifra);
		
		adresa = new JTextField();
		adresa.setBounds(706, 231, 178, 20);
		panel.add(adresa);
		adresa.setColumns(10);
		
		polo = new JTextField();
		polo.setBounds(706, 195, 178, 20);
		panel.add(polo);
		polo.setColumns(10);
		
		JLabel lblNewLabel_6 = new JLabel("Pol");
		lblNewLabel_6.setBounds(625, 198, 46, 14);
		...
		btnNewButton.setBounds(795, 297, 89, 23);
		...
		btnNewButton_1.setBounds(699, 297, 89, 23);
		...
		btnNewButton_2.setBounds(699, 331, 89, 23);
		panel.add(btnNewButton_2);
		
		JLabel Labla = new JLabel("Plata");
		Labla.setBounds(625, 269, 46, 14);
		panel.add(Labla);
		
		plata = new JTextField();
		plata.setBounds(706, 266, 178, 20);
		panel.add(plata);
		plata.setColumns(10);
